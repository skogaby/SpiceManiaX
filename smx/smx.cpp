...
SMXWrapper::SMXWrapper() {
    ...
    if (LIBSMX_INSTANCE != nullptr) {
        // Load functions
        pSMX_Start =
            (SMX_Start_t) GetProcAddress(LIBSMX_INSTANCE, "SMX_Start");
        pSMX_SetLights2 =
            (SMX_SetLights2_t) GetProcAddress(LIBSMX_INSTANCE, "SMX_SetLights2");
        ...
        if (pSMX_Start == nullptr || pSMX_SetLights2 == nullptr || pSMX_SetDedicatedCabinetLights == nullptr) {
